...
For additonal functionalities, please see batplot (developed by Tian Dai). Can be installed through a terminal using pip install batplot

Please don't hesitate to reach out to Amalie for additional capabilities
